...
const teamData = [
  { id: 1, name: "MAROJAHAN CHRISTIAN COKIRAY HUTAHAEAN", img: tm1, about: "Halo namaku Marojahan Coky Ray Hutahaean! Aku suka dengan lawan yang kuat dalam adu kekuatan otot, Panco. Ya setidaknya hanya beberapa yang dapat mengalahkanku setelah kemenanganku yang beruntun, oh ya, infokan permabaran terdekat, Mobile Legend adalah makanan sehari-hariku." },
